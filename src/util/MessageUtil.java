...
public class MessageUtil {
    public static List<String> allExistingMessages = Arrays.asList(
            "Summer is coming",
            "a1d22n333a4444p",
            "oaaawaala",
            "zmzmzmzaztzozh",
    ...
    public static String getMessage(int index) {
        return allExistingMessages.size() > index ? allExistingMessages.get(index) : "";
    }

    public static int getMessageListSize() {
        return allExistingMessages.size();
    }
}
